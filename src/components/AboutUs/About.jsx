  ...
  const faqData = [
    {
      ...
      answer:
        "We offer a diverse fleet of vehicles to suit your lifestyle. From fuel-efficient economy cars and spacious SUVs to luxury sedans and versatile vans, we have the perfect ride for every adventure. Experience the comfort, convenience, and reliability of our rental fleet. Book your rental car today!",
    },
    {
      id: 2,
      question:
        "Do you offer rental cars with automatic or manual transmission?",
      answer:
        "We offer a diverse fleet of vehicles to suit your lifestyle, including both automatic and manual transmissions. Choose the transmission that best fits your driving preferences when making your reservation.",
    },
    {
      id: 3,
      question: "Do you offer rental cars with GPS navigation?",
      answer:
        "Yes, we offer a selection of rental cars equipped with GPS navigation systems. This convenient feature can help you navigate unfamiliar areas with ease and confidence. Whether you're exploring a new city, embarking on a road trip, or simply need directions to your destination, GPS navigation can be a valuable tool.",
    },
    {
      id: 4,
      question: "Do you offer child car seats?",
      answer:
        "While we do not provide child car seats directly, we strongly encourage you to bring your own to ensure the safety of your child during your rental. We understand that child car seats can be bulky and inconvenient to travel with, but the safety of your child is our top priority. If you have any questions or concerns about child car seat safety, please don't hesitate to ask our staff.",
    },
    {
      id: 5,
      question: "Do you offer insurance options?",
      answer:
        "Yes, we offer a variety of insurance options to protect you and your rental vehicle. While most major credit cards offer some form of rental car insurance, it's important to understand the coverage limits and exclusions. Please note that insurance coverage may vary depending on your location and specific rental agreement. We encourage you to review your personal insurance policies and credit card benefits before making a decision. Our rental agents can provide additional information and help you select the insurance options that best suit your needs.",
    },
    {
      id: 6,
      question: "How far in advance should I make a reservation?",
      answer:
        "We recommend making your reservation as far in advance as possible to ensure the availability of your desired vehicle. For peak travel seasons or special events, it's advisable to book several weeks or even months ahead. However, we often have last-minute availability, so feel free to check our website or contact us for the latest updates.",
    },
    {
      id: 7,
      question: "Do you have age restrictions for renting a car?",
      answer:
        "Yes, we do have age restrictions for renting a car. Minimum age: Our minimum age for renting a car is 21. Additional requirements: In addition to age, you may also need to provide a valid driver's license with a minimum 5 years of driving experience.",
    },
    {
      id: 8,
      question: "Can I cross the border with my rental car?",
      answer:
        "No, you cannot cross the border with a rental car. Our rental agreement explicitly prohibits crossing international borders. If you intend to travel outside of India, we recommend arranging transportation or renting a car locally at your destination. Please note: Crossing borders with a rental car without authorization can result in serious penalties, including fines and vehicle seizure.",
    },
    {
      id: 9,
      question: "What payment methods do you accept?",
      answer:
        "Credit Cards: Visa, Mastercard, American Express, Discover. Debit Cards: Visa, Mastercard. Cash: We accept cash payments at our physical locations. Third-Party Payment Apps: We may accept payments through certain third-party payment apps, such as Apple Pay or Google Pay. Please check with us for the latest options.",
    },
    {
      id: 10,
      question: "Do you require a security deposit?",
      answer:
        "Yes, we require a security deposit to hold your reservation. The amount of the deposit will vary depending on the type of vehicle you rent and the length of your rental period. The deposit is fully refundable upon the return of the vehicle in the same condition it was received, with no damage or missing items. We understand that this may be an additional cost, but it helps to protect us against potential losses due to accidents, damage, or theft. We appreciate your understanding and cooperation.",
    },
  ];
  return (
    <div>
      <Helmet>
        ...
        <link rel="canonical" href={`${import.meta.env.VITE_URL_SEO}/About`} />
        ...
        />
        <meta property="og:url" href={`${import.meta.env.VITE_URL_SEO}/About`} />
        <meta
          property="og:image"
            ...
            <div className="container">
              ...
              <div className="block-faqs">
                <div className="accordion" id="accordionFAQ">
                  {faqData.map((item) => (
                    <div
                      className="accordion-item fadeInUp border-bottom-0"
                      key={item.id}
                    >
              ...
              <div className="row">
                <div className="col-12 wow fadeInUp mt-4">
                  <div className="d-flex justify-content-center gap-2">
                    <Link to="/Contact-Anytime-rent-a-car">
                      <div className="btn btn-primary mt-2">
                        Contact Us
                        <svg
                          width={16}
